...
const stores = [
  {
    ...
    products: [
      ...
      {
        image:
          "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=150&q=80",
        price: "₹2,70,000",
      },
      {
        image:
          "https://images.unsplash.com/photo-1514327605112-b887c0e61c0a?auto=format&fit=crop&w=150&q=80",
        price: "₹99,000",
      },
    ],
  },
  {
    ...
    products: [
      {
        image:
          "https://images.unsplash.com/photo-1520975954732-57dd22299614?auto=format&fit=crop&w=150&q=80",
        price: "₹3,24,000",
      },
      {
        image:
          "https://images.unsplash.com/photo-1491553895911-0055eca6402d?auto=format&fit=crop&w=150&q=80",
        price: "₹1,99,000",
      },
      {
        image:
  ...
  },
  {
    ...
    products: [
      {
        image:
          "https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&w=150&q=80",
        price: "₹1,79,000",
      },
      {
        image:
  ...
  },
  {
    ...
    products: [
      {
        image:
          "https://images.unsplash.com/photo-1548883354-94cbffee4e03?auto=format&fit=crop&w=150&q=80",
        price: "₹2,50,000",
      },
      {
        image:
          "https://images.unsplash.com/photo-1591195853828-11db59a44f6b?auto=format&fit=crop&w=150&q=80",
        price: "₹1,62,000",
      },
      {
        image:
        ...
        <div className="store-mall-card">
          <div className="mall-image-wrapper">
            <img
              ...
              alt="Mall Shopping Bags"
            />
          </div>
          <div className="mall-card-content">
            <h3 className="mall-title">shopsmart Mall</h3>
            <p className="mall-desc">
              Shop, Explore, Delight and
              <br />
              Experience Mall Magic!
            </p>
          </div>
        </div>
